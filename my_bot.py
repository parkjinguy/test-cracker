...
class chatbot(discord.Client):
    ...
    async def on_message(self, message):
        ...
        if message.content == "!도움말":
            ...
            aa= aa+" !반대, !투표종료, !요염, !뭘 꼬라봐, !사륜안, !경이, 흐믓, 모름, 사딸라, 다이어트\n"
        ...
        if  message.content == "!뭘 꼬라봐":
            ...
            await message.channel.send(file=file)
            return None
        if  message.content == "!사륜안":
            dirctory = os.path.dirname(__file__)
            file=discord.File(dirctory+"a6.jpg")
            await message.channel.send(file=file)
            return None
        if  message.content == "!경이":
            dirctory = os.path.dirname(__file__)
        ...
        if "!롤." in message.content:
            ...
            APIURL = "https://kr.api.riotgames.com/lol/summoner/v4/summoners/by-name/" + arr_str[1] #encodingSummonerName
            headers = {
